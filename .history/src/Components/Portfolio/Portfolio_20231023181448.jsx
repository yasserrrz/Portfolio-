...
,
{
  ...
  demo: "",
  showFullText: false,
  text:"Responsive static recipe website build with JavaScript , jQuery and bootstrap , using API to fetch the data from it , where the API is divided into categories , areas , search , contact"
}
,
{
  name:"",
