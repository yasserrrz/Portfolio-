  ...
  return (
   <>
        ...
        <section id='contact' className='position-relative container  text-center py-5'>
             ...
             <h2 className='my-3 text-info'>Contact Me</h2>
             ...
             <div className="  contact_contaner ">
              ...
              <div className="contact_options col-12 col-md-4 z-3">
                ...
                <article className='contact_option' data-aos="zoom-in">
                  <MdOutlineEmail className='contact_option_icon'/>
                    <h4>Email</h4>
                    <h5 className=''>yasserrmohammed44@gmail.com</h5>
                    <a href="mailto:yasserrmohammed44@gmail.com" target={`_blank`}>Send a message</a>
                </article>
                ...
                <article className='contact_option' data-aos="zoom-in">
                  <BsLinkedin className='contact_option_icon'/>
                    ...
                    <a href='https://www.linkedin.com/in/yasser-mohamed-5ba73a198/' target={`_blank`}>Send a message</a>
                </article>
                  ...
                  <div className="w-auto">
                    {isSent ? (
                      <button className="glow-on-hover" type="button" onClick={handleFormSubmit} disabled={!isFormValid}>
                        <p className='my-0 mx-2'>Send Message</p>
                      </button>
                    ) : (
                      <div className='d-flex align-items-center justify-content-center'>
                        ...
                        <p className='p-0 m-0 ms-3'>Sending your message....</p>
                      </div>
                    )}
                  </div>
                </div>
