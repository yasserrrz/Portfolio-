  ...
  <>
        <div className="cta mt-3 d-flex gap-3 justify-content-center position-relative mb-4">
            <a href={CV} download className=' btn_animation text-decoration-none   d-flex align-items-center '>
             <p className='m-0 p-0 download_cv'>Download CV</p>
            </a>
            <Link className='glow-on-hover m-0 text-decoration-none d-flex justify-content-center align-items-center' to={"/contactUs"}>
              <p className= "m-0 p-0 download_cv">
              Let's Talk
              </p>
              </Link>
        </div>
